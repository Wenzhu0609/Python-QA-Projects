...
with open('/Users/angelaliu/Documents/Python/Python-QA-Projects/Python_Back_End_Automaton/Course.json') as f1:
    data1 = json.load(f1)
    print(data1)
    print(type(data1))
...
with open('/Users/angelaliu/Documents/Python/Python-QA-Projects/Python_Back_End_Automaton/Course1.json') as f2:
    data2 = json.load(f2)
    assert data1 == data2
